...
<body class="gray-bg">
						...
						<form method="post" class="form-horizontal" id="form">
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									...
									<button class="btn btn-primary" type="button" id="but">修&nbsp;&nbsp;改</button>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	$("#but").click(function() {
		...
		$.post("/employee/update?id=${employee.id}",data,function (data) {
			if (data=="success"){
				parent.layer.alert('修改成功！',{icon: 1});
				window.location.href="/employee/information?id=${employee.id}"
			}else {
