						...
						<table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            %>
								...
								%>
									...
									<td><a href="<%=path %>/history/<%=history.getId() %>/detail" class="btn btn-info">查看</a>&nbsp;&nbsp;
										<a href="<%=path %>/history/<%=history.getId() %>/toUpdate" class="btn btn-primary">修改</a>&nbsp;&nbsp;
								</tr>
							<%
                            		}
                           		 }
						...
						<div>
							...
							<nav aria-label="Page navigation" style="margin: 0 auto; width: 240px">
								<ul class="pagination" style="margin: 0;">
									<li>
										<a href="<%=path %>/history/retireListPage?pageNo=<%=pe.getCurrent()-1>1?pe.getCurrent()-1:1 %>"
								...
								%>
									<li><a href="<%=path %>/history/retireListPage?pageNo=<%=i%>"><%=i %></a></li>
								<%
	 								 }
								%>
									<li><a href="<%=path %>/history/retireListPage?pageNo=<%=pe.getCurrent()+1<pe.getPages()?pe.getCurrent()+1:pe.getPages() %>"
