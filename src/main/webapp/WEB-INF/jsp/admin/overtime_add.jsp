...
<body class="gray-bg">
						...
						<form method="post" class="form-horizontal" id="form">
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									<button class="btn btn-success" type="button" id="but">添&nbsp;&nbsp;加</button>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	$("#but").click(function () {
        ...
        $.post("/overtime/add",data,function (r) {
            if (r=="success"){
                parent.layer.alert('添加成功！',{icon: 1});
                window.location.href="/overtime/<%=employee1.getEmployeeNumber() %>/oneself";
            }else {
                parent.layer.alert('添加失败！',{icon: 1});
                window.location.href="/overtime/toAdd"
            }
        });
    })
	</script>
