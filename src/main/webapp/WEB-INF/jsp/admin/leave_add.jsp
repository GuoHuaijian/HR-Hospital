...
<body class="gray-bg">
						...
						<form method="post" class="form-horizontal" id="form">
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-8">
									<button class="btn btn-success" type="button" id="but">申&nbsp;&nbsp;请</button>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	$("#but").click(function () {
		...
		$.post("/leave/add?employeeNumber=<%=employee.getEmployeeNumber() %>",data,function (r) {
			if (r=="success"){
				parent.layer.alert('申请提交成功！',{icon: 1});
				window.location.reload();
			} else {
				parent.layer.alert('申请提交失败！',{icon: 1});
				window.location.reload();
			}
		})
	})
