					...
					<div class="ibox-content">
						...
						<table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            %>
								...
								%>
									<td><%=intime %></td>
									<td><a href="<%=path %>/employee/<%=employee.getId() %>/detial" class="btn btn-info">查看</a>&nbsp;&nbsp;
										<a href="<%=path %>/employee/toUpdate?id=<%=employee.getId() %>" class="btn btn-primary">修改</a>&nbsp;&nbsp;
						...
						<div>
							...
							<nav aria-label="Page navigation" style="margin: 0 auto; width: 240px">
								<ul class="pagination" style="margin: 0;">
									<li>
										<a href="<%=path %>/employee/employeeList?pageNo=<%=pe.getCurrent()-1>1?pe.getCurrent()-1:1 %>"
								...
								%>
									<li><a href="<%=path %>/employee/employeeList?pageNo=<%=i%>"><%=i %></a></li>
								<%
	 								 }
								%>
									<li><a href="<%=path %>/employee/employeeList?pageNo=<%=pe.getCurrent()+1<pe.getPages()?pe.getCurrent()+1:pe.getPages() %>"
